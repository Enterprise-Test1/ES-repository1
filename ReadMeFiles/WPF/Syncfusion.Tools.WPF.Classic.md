This package provides theme XAML files for SkinStorage based themes (Blend, Metro, Office2007, VS2010), and controls (RangeSliderControl, NotifyIcon) marked as classic in Essential Studio for WPF.
